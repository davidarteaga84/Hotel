...
class reserva_db {
	...
	public function mostrar_disponibles($reservaDB,$cat) { //Torna habitacions disponibles segons categoria i data
		...
		/*$sql=
SELECT habitacio.numHabitacio
FROM habitacio
WHERE habitacio.numHabitacio Not In 

(SELECT habitacio 
             FROM reserva
WHERE '2014-03-19' <= dataEntrada AND '2014-03-19' >= dataEntrada OR '2014-03-19' >= dataEntrada AND '2014-03-19' <= dataEntrada)*/
		$connexio = new db();
